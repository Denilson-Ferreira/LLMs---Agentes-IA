...
Projeto executável de QA Agent inspirado no curso **A2A: The Agent2Agent Protocol**, usando Groq como provedora da LLM.
...
Abra [agente_qa_groq.ipynb](./agente_qa_groq.ipynb). Por padrão, `RUN_LIVE_DEMOS=false`; assim, executar todas as células faz as validações locais, mas não envia perguntas pagas ao modelo.
