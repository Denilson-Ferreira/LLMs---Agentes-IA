...
# fictícia usando um modelo servido pela Groq. QA significa
...
#
# ```bash
# pip install -r requirements_04_a2a.txt
# ```
#
...
def locate_project_dir() -> Path:
    ...
    candidates = [current, current / "experiments" / "04-acp-protocolo"]
    candidates.extend(parent / "experiments" / "04-acp-protocolo" for parent in current.parents)
...
# %%
# Carregamento da apólice fictícia
